                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li>
                                <a href="#" class="active">Group Member</a>
                            </li>
                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <form class="form-horizontal" action="/PIMDSWEB/UserUploadGroupMember" method="post" enctype="multipart/form-data" >
                                <div class="form-group">
                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">Select Project</label>

                                    <div class="col-sm-9">

                                        <select class="chosen-select form-control" id="form-field-select-3" name="ProjecId" data-placeholder="Choose a Project..." >
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">Select Group Member</label>

                                    <div class="col-sm-9">
                                        <select multiple="" class="chosen-select form-control" name="UserIds" id="form-field-select-4" data-placeholder="Choose a Group Member..." >
                                            <option value="null" >------------Select------------</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="form-field-1" name="GroupName" placeholder="Group Name" class="col-xs-10 col-sm-5" />

                                    </div>
                                </div>
                                <div class="clearfix form-actions">
                                    <div class="col-md-offset-3 col-md-9">
                                        <input type="submit" class="btn btn-info bigger-150 " name="op" value="Add"  />
                                        &nbsp; &nbsp; &nbsp;
                                        <button class="btn" type="button" onclick="location.href = 'People.jsp'">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <select class="form-control" id="form-field-select-1" onchange="ShowGroupMember(this.value)" >
                                            ...
                                            <% List<BusinessObject.ProjectDetail> projectDetails = BusinessLogic.ProjectDetailBL.GetAll();
                                                ...
                                                for (int i = 0; i < projectDetails.size(); i++) {
                                                    ...
                                                    String Name = String.format("<option value='%s'>%s</option>", projectDetails.get(i).getId(), projectDetails.get(i).getName());
            ...
            function ShowGroupMember(str) {
                ...
                xhttp.onreadystatechange = function () {
                    if (this.readyState == 4 && this.status == 200) {
                        ...
                        document.getElementById("ShowGroupMember").innerHTML = this.responseText;
                    }
                };
                xhttp.open("GET", "/PIMDSWEB/UserUploadGroupMember?Id=" + str, true);
                xhttp.send();
            }
        </script>
    </body>
