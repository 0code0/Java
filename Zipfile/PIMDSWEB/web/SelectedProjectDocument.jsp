...
<html lang="en">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Selected Project Document</title>
    ...
    <body class="no-skin">
                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li class="ace-icon">
                                <a href="ViewProject.jsp">Show All Project</a>
                            </li>
                            <li class="active">
                                <a href="#">Selected Project Document</a>
                            </li>
                    ...
                    <div class="page-content">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <select  name="ProjectCategory" onchange="ShowProjectDetail(this.value)" class="form-control" id="form-field-select-1" >
        ...
        <script>
            ...
            function getShowProjectDetail() {
                var xhttp;

                xhttp = new XMLHttpRequest();
                xhttp.onreadystatechange = function () {
                    if (this.readyState == 4 && this.status == 200) {
                        document.getElementById("getShowProjectDetail").innerHTML = this.responseText;
                    }
                };
                xhttp.open("POST", "/PIMDSWEB/GetAllProjectByCategory", true);
                xhttp.send();
            }
