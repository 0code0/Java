...
public final class AfterCreateNew_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    return;
      ...
      out.write("        <title> After Create New </title>\n");
      out.write("\n");
 ...
 BusinessObject.ProjectDetail projectName = BusinessLogic.ProjectDetailBL.GetSingle(Integer.parseInt(request.getParameter("Id")));
      ...
      out.write("                                        ");
                                            ...
                                            File Reporting_file = new File(Reportingroot + "/" + request.getParameter("Reportingfile"));
      ...
      out.write("                                            <label class=\"col-sm-3 control-label no-padding-right\" for=\"form-field-1\" style=\"width: 43%;\"></label>\n");
      out.write("\n");
      out.write("                                            <div class=\"col-sm-9\" style=\"font-size: large;color: blueviolet;width: 20%\">\n");
      out.write("                                                ");
      out.print( Header);
      out.write("\n");
      out.write("                                            </div>\n");
      ...
      out.write("\n");
      out.write("                                                ");
  Scanner Milestonefilescan = new Scanner(new File(Milestoneroot + "/" + request.getParameter("Milestonefile")));
      ...
      out.write("                                    ");
                                        ...
                                        File Checklockfile = new File(Lockfileroot + "/Locked_" + request.getParameter("Id") + "_" + request.getParameter("Week") + "_" + request.getParameter("Year") + ".txt");
                                        Checklockfile.delete();
                                        String BodyDetail = Header + "</br><table style=\"border-collapse: collapse;width: 100%;text-align: left;border: 1px solid darkorange;\"   >\n"
                                                ...
                                                + "                                                </tr>\n";
                                        for (int i = 0; i < Milestones.size(); i++) {
                                            BodyDetail.concat("<tr style=\"background-color: #f2f2f2;\">\n"
                                                    + "                                                    <td> " + Milestones.get(i) + " </td>\n"
                                                    + "                                                    <td> " + InitialPropisedPlanes.get(i) + " </td>\n"
                                                    + "                                                    <td> " + LastAgreedPlanes.get(i) + " </td>\n"
                                                    + "                                                    <td> " + PresentForeCasts.get(i) + " </td>\n"
                                                    + "                                                    <td> " + Achieveds.get(i) + " </td>\n"
                                                    + "                                                    <td> " + Delays.get(i) + " </td>\n"
                                                    + "                                                </tr>\n");
                                        }
                                        BodyDetail.concat("</table>");

                                        String Report = "</br><table style=\"border-collapse: collapse;width: 40%;text-align: left;border: 1px solid darkorange;\"   >\n"
                                                + "<tr style=\"background-color: #f2f2f2;\" >\n"
                                                + "                <td colspan=\"2\" style=\"color: red;font-weight: bold;\"> Reporting </td>\n"
                                                + "            </tr>\n"
                                                + "            <tr style=\"background-color: #f2f2f2;\">\n"
                                                + "                <td style=\"color: black;font-weight: bold;\"> Achievements </td>\n"
                                                + "                <td> " + Achievements + " </td>\n"
                                                + "            </tr>\n"
                                                + "            <tr style=\"background-color: #f2f2f2;\">\n"
                                                + "                <td style=\"color: black;font-weight: bold;\"> Issues </td>\n"
                                                + "                <td> " + Issues + " </td>\n"
                                                + "            </tr>\n"
                                                + "            <tr style=\"background-color: #f2f2f2;\">\n"
                                                + "                <td style=\"color: black;font-weight: bold;\"> Details </td>\n"
                                                + "                <td> " + Details + " </td>\n"
                                                + "            </tr>\n"
                                                + "            <tr style=\"background-color: #f2f2f2;\">\n"
                                                + "                <td style=\"color: black;font-weight: bold;\"> Plan </td>\n"
                                                + "                <td> " + Plan + " </td>\n"
                                                + "            </tr>\n"
                                                + "\n"
                                                + "        </table></br> Thanks & Regards</br><p style='color:red;'>This is a system generated mail. Please do not reply</p>";
                                        ...
                                        email.setTo("jaswinder.singh@st.com");
                                        email.setSubject("WEEKLY SUBMITED Project:-" + projectName.getName() + " WEEK:-" + request.getParameter("Week") + "YEAR" + request.getParameter("Year"));
                                        email.setBody("Hello,</br>" + request.getSession().getAttribute("Name") + " has submited weekly for " + projectName.getName() + "</br> Detail are here:" + BodyDetail + Report);
