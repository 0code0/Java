                ...
                <div class="navbar-header pull-right">
                    <a href="#" class="navbar-brand">
                        <small>
                            ...
                            <%= request.getParameter("NewWeekNumber")%>
                        </small>
                    </a>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <form method="post" action="<%= request.getContextPath()%>/CreateFromCloneMilestoneAndReporting" enctype="multipart/form-data" >
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"></label>

                                                <div class="col-sm-9">
                                                    <input type="text" id="form-field-1" placeholder="Header" value="<%= Header%>" style="width: 515px;" name="Header" class="col-xs-10 col-sm-5" />
                                            ...
                                            <input type="hidden" name="Week" value="<%= request.getParameter("NewWeekNumber")%>" />
                                            ...
                                            <div class="col-xs-12">
                                                <table id="myTable" class="table  table-bordered table-hover">
                                                    ...
                                                    <tr>
                                                        <td ><textarea rows='2' cols='20' name="Milestone" ><%= Milestones.get(i)%></textarea></td>
                                                        <td ><textarea rows='2' cols='20' name="InitialPropisedPlane" ><%= InitialPropisedPlanes.get(i)%></textarea></td>
                                                        <td ><textarea rows='2' cols='20' name="LastAgreedPlane" ><%= LastAgreedPlanes.get(i)%></textarea></td>
                                                        <td ><textarea rows='2' cols='20' name="PresentForeCast" ><%= PresentForeCasts.get(i)%></textarea></td>
                                                        <td ><textarea rows='2' cols='20' name="Achieved" ><%= Achieveds.get(i)%></textarea></td>
                                                        <td ><textarea rows='2' cols='20' name="Delay" ><%= Delays.get(i)%></textarea></td>
                                                        <td ><button class="btn btn-xs btn-danger" onclick="deleteRow(this)"><i class="ace-icon glyphicon  glyphicon-minus white bigger-110"></i></button>
                                                        </td>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-12 col-sm-9">
                                                    <div class="clearfix">
                                                        <textarea class="input-xxlarge" placeholder="Achievements" name="Achievements" ><%= Achievements%></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            </br>
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-12 col-sm-9">
                                                    <div class="clearfix">
                                                        <textarea class="input-xxlarge" placeholder="Issues" name="Issues" ><%= Issues%></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            </br>
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-12 col-sm-9">
                                                    <div class="clearfix">
                                                        <textarea class="input-xxlarge" placeholder="Details" name="Details" ><%= Details%></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            </br>
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-12 col-sm-9">
                                                    <div class="clearfix">
                                                        <textarea class="input-xxlarge" placeholder="Plan" name="Plan" ><%= Plan%></textarea>
                                                    </div>
                                                </div>
                                            </div>
