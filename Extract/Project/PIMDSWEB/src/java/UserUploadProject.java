 ...
 * @author singhj1
 */
public class UserUploadProject extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        comment.setProjectDocumentId(Integer.parseInt(request.getParameter("DocumentId")));

        comment.setUserId(Integer.parseInt(httpsession.getAttribute("Id").toString()));
