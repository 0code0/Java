 ...
 * @author singhj1
 */
public class GetUserSubValue extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println(" <select name=\"ProjectSubCategory\" class=\"form-control\" id=\"form-field-select-1\" style=\"width: 373px;\">");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            /* TODO output your page here. You may use following sample code. */
            out.println("<select class=\"form-control\" id=\"form-field-select-1\" name=\"ProjectSubClass\" style=\"width: 373px;\">");
            out.println("<option value=\"null\">-----Select-----</option>");
